...
export const DEFAULT_VIDEOS: VideoLesson[] = [
  ...
  {
    id: "cat-strategy-masterclass",
    youtubeId: "zu3eOb8IXF0",
    title: "CAT Strategy & Smart Preparation Masterclass",
    instructor: "Prof. Arun Kumar",
    description:
      "A complete elite-level CAT strategy masterclass covering smart preparation frameworks, time management systems, section-wise scoring blueprints, mock test analysis cycles, and last-mile revision plans. Prof. Arun Kumar walks through the exact 8-minute reading battle plan that top scorers use to dominate VARC, plus advanced strategies for QA and DILR under real exam pressure. Designed for aspirants who want a structured, data-driven approach to achieving 99+ percentile.",
    duration: "48:30",
    views: "36K",
    rating: 4.9,
    category: "Strategy",
    access: "elite",
    tags: [
      "CAT Strategy", "Smart Preparation", "CAT 2024", "99 Percentile",
      "Time Management", "Mock Analysis", "Reading Strategy", "IIM",
      "Elite CAT Prep", "Prof. Arun Kumar",
    ],
    featured: true,
    order: 9,
    status: "published",
    deletedAt: null,
    xpToastMessage: "🎯 Elite strategy unlocked! You now think like a 99-percentiler.",
    aiSummary:
      "An elite strategy masterclass that distils exactly how top CAT scorers plan, execute, and adjust their preparation. Covers the 8-minute reading battle plan, section-specific scoring blueprints, mock analysis frameworks, and the final-month revision system.",
    keyTakeaways: [
      "8-minute reading battle plan: allocate reading time by passage complexity, not word count",
      "Attempt strategy: mark-and-move on any question unsolved in 2.5 minutes in QA",
      "Mock analysis cycle: 30 min post-mock review is more valuable than the next full mock",
      "Section sequencing: begin with your strongest section to build early momentum",
      "Last-month plan: 3 mocks per week + 2 sectional tests + daily formula revision",
      "Accuracy over attempts: 40 attempts at 88% accuracy beats 55 attempts at 70%",
      "Slot difference management: never compare raw scores across different CAT slots",
    ],
    quiz: [
      {
        id: "csmq1",
        question: "According to the 8-minute reading battle plan, time per RC passage should be allocated based on:",
        options: [
          "Number of questions in the passage",
          "Passage word count alone",
          "Passage complexity and question type mix",
          "Alphabetical order of topics",
        ],
        correctIndex: 2,
        explanation: "The battle plan prioritises complexity over length — a 400-word dense philosophy passage deserves more time than a 600-word straightforward economics passage. Matching time allocation to actual difficulty is the core insight.",
      },
      {
        id: "csmq2",
        question: "For a student targeting 99+ percentile in QA, which attempt-accuracy combination is optimal?",
        options: [
          "55 attempts at 70% accuracy",
          "40 attempts at 88%+ accuracy",
          "30 attempts at 100% accuracy",
          "50 attempts at 80% accuracy",
        ],
        correctIndex: 1,
        explanation: "40 attempts at 88%+ accuracy yields ~35 correct answers. With +3/−1 marking: (35×3) − (5×1) = 100 raw score, which historically places at 99+ percentile in QA. High accuracy on fewer questions consistently outperforms high-volume low-accuracy strategies.",
      },
      {
        id: "csmq3",
        question: "What is the most impactful single action to take in the 30 minutes immediately after a mock test?",
        options: [
          "Start the next mock test immediately",
          "Calculate your expected percentile online",
          "Do a structured review of all attempted and skipped questions",
          "Rest and avoid looking at results until the next day",
        ],
        correctIndex: 2,
        explanation: "A 30-minute structured post-mock review — covering correct guesses, wrong logic, and skip patterns — builds more exam intelligence than taking the next mock. The review compounds your learning from every single question.",
      },
    ],
  },
  {
  ...
  {
    id: "cat-preparation-masterclass-1q2hekcur1s",
    youtubeId: "1q2HekCuR1s",
    title: "Mastering Percentages for CAT",
    instructor: "Rajiv Mehta",
    description:
      "A comprehensive CAT-focused deep dive into Percentages — one of the highest-frequency topics in the QA section. Master percentage calculations, successive change, percentage-fraction equivalents, reverse percentage, and real-world CAT-level applications. Packed with rapid mental math tricks, shortcut grids, and worked examples from actual CAT Previous Year Questions that make even the hardest percentage problems solvable in under 90 seconds.",
    duration: "45:00",
    views: "30K",
    rating: 4.9,
    category: "QA",
    access: "elite",
    tags: [
      "Percentages", "CAT QA", "Quantitative Aptitude", "CAT Math",
      "Mental Math", "CAT 2024", "Percentage Tricks", "QA Shortcuts",
      "Rajiv Mehta", "99 Percentile",
    ],
    featured: false,
    order: 11,
    status: "published",
    deletedAt: null,
    xpToastMessage: "💯 Percentage mastery unlocked! Speed and accuracy in QA just levelled up.",
    aiSummary:
      "An elite QA session dedicated entirely to Percentages — covering basic to advanced CAT-level problems. Includes mental math tricks, successive percentage change, percentage-to-fraction conversion grids, and PYQ walkthroughs for blazing-fast, high-accuracy solving.",
    keyTakeaways: [
      "Fraction-percentage equivalents (1/8 = 12.5%, 1/6 = 16.67%) must be memorised — they cut calculation time by 60%",
      "Successive percentage change: net % = a + b + ab/100 — never add percentages directly",
      "Reverse percentage: if price rises by 25%, original = new price ÷ 1.25, not new − 25%",
      "Population/profit growth: use multiplier method (×1.2 for 20% up, ×0.8 for 20% down)",
      "CAT trap: 'x% of y = y% of x' — swap to whichever form is easier to compute",
      "For 2-step successive changes, the combined multiplier equals product of individual multipliers",
      "Practice speed drills: 15 percentage questions in 10 minutes — accuracy above 90% is the target",
    ],
    quiz: [
      {
        id: "pctq1",
        question: "A price is first increased by 20% and then decreased by 20%. The net change is:",
        options: ["0%", "−4%", "+4%", "−2%"],
        correctIndex: 1,
        explanation: "Successive change: net % = 20 + (−20) + (20×(−20))/100 = 0 − 4 = −4%. The multiplier method: 1.2 × 0.8 = 0.96 → 4% decrease. This is a classic CAT trap — the answer is never 0%.",
      },
      {
        id: "pctq2",
        question: "If 37.5% of a number is 120, what is 62.5% of that number?",
        options: ["180", "200", "160", "240"],
        correctIndex: 1,
        explanation: "37.5% = 3/8, so 3/8 of N = 120 → N = 320. Then 62.5% = 5/8 of 320 = 200. Using fraction equivalents avoids any long division and solves this in under 20 seconds.",
      },
      {
        id: "pctq3",
        question: "A shopkeeper marks goods at 40% above cost and gives a 25% discount. The profit percent is:",
        options: ["5%", "15%", "10%", "20%"],
        correctIndex: 0,
        explanation: "Multiplier approach: selling price = cost × 1.4 × 0.75 = cost × 1.05. Profit = 5%. Memorise: mark-up × discount multiplier = net multiplier. This beats percentage-on-percentage arithmetic every time.",
      },
    ],
  },
  {
    id: "cat-video-cpvf0ldqrvc",
    youtubeId: "CPVf0ldQRvc",
    title: "Profit & Loss Playbook for CAT",
    instructor: "Rajiv Mehta",
    description:
      "Master every Profit & Loss concept tested in CAT QA — from basic cost-selling price relationships to marked price, successive discounts, dishonest dealings, and partnership profit splits. This playbook-style session teaches shortcut multiplier methods, formula-free approaches for complex multi-step problems, and works through high-difficulty CAT PYQs at exam speed. Essential for aspirants who want to make P&L a guaranteed scoring zone.",
    duration: "45:00",
    views: "30K",
    rating: 4.9,
    category: "QA",
    access: "elite",
    tags: [
      "Profit Loss", "CAT QA", "Quantitative Aptitude", "P&L Shortcuts",
      "CAT Math", "CAT 2024", "Marked Price", "Discount", "QA Strategy",
      "99 Percentile",
    ],
    featured: false,
    order: 12,
    status: "published",
    deletedAt: null,
    xpToastMessage: "💰 P&L mastery unlocked! Every trade question is now a scoring opportunity.",
    aiSummary:
      "A complete CAT Profit & Loss playbook covering multiplier shortcuts, marked price and discount chains, dishonest dealer problems, and partnership profit splits. Designed for aspirants who want to solve P&L questions in under 60 seconds with zero formula dependency.",
    keyTakeaways: [
      "Multiplier method: always express profit/loss as a multiplier (20% profit → ×1.2) to chain steps",
      "Marked price shortcut: SP = MP × (1 − discount/100) — never subtract discount amount from MP directly",
      "Dishonest dealer formula: gain% = (true weight − false weight) / false weight × 100",
      "Two successive discounts of a% and b%: net discount = a + b − ab/100 (not a + b)",
      "Cost price from SP + profit%: CP = SP / (1 + profit/100) — reverse multiplier is fastest",
      "Partnership profit splits: ratio of profits = ratio of (capital × time) for each partner",
      "CAT trap: 'profit on CP vs profit on SP' — always clarify which base the % is applied to",
    ],
    quiz: [
      {
        id: "plq1",
        question: "A trader marks goods at 50% above cost price and gives a 20% discount. What is the profit percent?",
        options: ["30%", "20%", "25%", "10%"],
        correctIndex: 1,
        explanation: "Multiplier: SP = CP × 1.5 × 0.8 = CP × 1.2. Profit = 20%. No intermediate amount needed — just multiply the multipliers. This is the fastest P&L method for CAT.",
      },
      {
        id: "plq2",
        question: "A dishonest shopkeeper uses a 900g weight instead of 1000g. His gain percent is:",
        options: ["10%", "11.11%", "9%", "12.5%"],
        correctIndex: 1,
        explanation: "Gain% = (1000 − 900) / 900 × 100 = 100/900 × 100 ≈ 11.11%. The denominator is the false weight (what he actually gives), not the true weight — a classic CAT trap.",
      },
      {
        id: "plq3",
        question: "If two successive discounts of 30% and 20% are applied, the net discount is:",
        options: ["50%", "44%", "46%", "40%"],
        correctIndex: 1,
        explanation: "Net discount = 30 + 20 − (30×20)/100 = 50 − 6 = 44%. Equivalently: multiplier = 0.7 × 0.8 = 0.56, so net discount = 44%. Never add successive discounts directly.",
      },
    ],
  },
  {
    id: "cat-video-pcrzsfwrwzu",
    youtubeId: "pCrzsFWrWzU",
    title: "TSD Fast Methods: Time, Speed & Distance for CAT",
    instructor: "Rajiv Mehta",
    description:
      "Master Time, Speed & Distance for CAT QA with fast-method frameworks that eliminate long algebra. This guide covers relative speed, trains and boats, circular tracks, average speed traps, meeting-point problems, and upstream/downstream logic — all solved using ratio-shortcut methods that cut solving time to under 75 seconds per question. Includes high-frequency CAT PYQ walkthroughs with annotated solution paths.",
    duration: "52:00",
    views: "35K",
    rating: 4.9,
    category: "QA",
    access: "elite",
    tags: [
      "TSD", "Time Speed Distance", "CAT QA", "Quantitative Aptitude",
      "Relative Speed", "CAT Math", "CAT 2024", "QA Shortcuts",
      "Trains Boats", "99 Percentile",
    ],
    featured: false,
    order: 13,
    status: "published",
    deletedAt: null,
    xpToastMessage: "🚀 TSD mastery unlocked! Speed problems are now your scoring zone.",
    aiSummary:
      "A fast-methods guide to CAT Time, Speed & Distance — covering relative speed, circular tracks, average speed traps, meeting points, and upstream/downstream problems. Ratio-based shortcuts replace algebra to keep solving time under 75 seconds per question.",
    keyTakeaways: [
      "Relative speed: same direction = |S1 − S2|, opposite direction = S1 + S2 — always draw a number line",
      "Average speed trap: avg speed ≠ (S1+S2)/2 unless equal distances; use 2S1·S2/(S1+S2)",
      "Train crossing a pole: time = length of train / speed of train (pole has zero length)",
      "Train crossing a platform: time = (length of train + length of platform) / speed of train",
      "Upstream/downstream: effective speed = boat speed ∓ stream speed; use sum/difference directly",
      "Circular track meeting point: time to meet = track length / relative speed",
      "CAT trick: if ratio of speeds is a:b, ratio of times for same distance is b:a — swap the ratio",
    ],
    quiz: [
      {
        id: "tsdq1",
        question: "A train 200m long crosses a platform 300m long in 25 seconds. What is the speed of the train in km/h?",
        options: ["54 km/h", "72 km/h", "60 km/h", "90 km/h"],
        correctIndex: 1,
        explanation: "Total distance = 200 + 300 = 500m in 25s. Speed = 500/25 = 20 m/s = 20 × 18/5 = 72 km/h. Always add both lengths before dividing by time.",
      },
      {
        id: "tsdq2",
        question: "A boat travels 48 km upstream in 4 hours and 48 km downstream in 3 hours. What is the speed of the stream?",
        options: ["2 km/h", "4 km/h", "3 km/h", "6 km/h"],
        correctIndex: 0,
        explanation: "Upstream speed = 48/4 = 12 km/h. Downstream speed = 48/3 = 16 km/h. Stream speed = (downstream − upstream)/2 = (16−12)/2 = 2 km/h.",
      },
      {
        id: "tsdq3",
        question: "A and B start from opposite ends of a 600m track. A runs at 5 m/s and B at 7 m/s. When do they first meet?",
        options: ["60 s", "50 s", "40 s", "75 s"],
        correctIndex: 1,
        explanation: "Moving toward each other, relative speed = 5 + 7 = 12 m/s. Time to first meeting = 600 / 12 = 50 seconds. Always add speeds for opposite-direction problems on a linear track.",
      },
    ],
  },
  {
    id: "cat-video-cqgb4aujncs",
    youtubeId: "CQGB4aujNCs",
    title: "Mastering Time & Work for CAT",
    instructor: "Rajiv Mehta",
    description:
      "A complete mastery guide to Time & Work for CAT QA — one of the highest-frequency and most formula-trap-prone topics in the section. Learn the LCM method for eliminating fractions, pipe-and-cistern shortcuts, combined work rates, negative work (emptying), and alternate-day working patterns. Every concept is solved using the fastest known shortcut with full PYQ walkthroughs designed for sub-60-second solutions under exam pressure.",
    duration: "45:00",
    views: "30K",
    rating: 4.9,
    category: "QA",
    access: "elite",
    tags: [
      "Time Work", "CAT QA", "Quantitative Aptitude", "LCM Method",
      "Pipes Cisterns", "Work Rate", "CAT Math", "CAT 2024",
      "QA Shortcuts", "99 Percentile",
    ],
    featured: false,
    order: 14,
    status: "published",
    deletedAt: null,
    xpToastMessage: "⚙️ Time & Work mastery unlocked! Combined work problems are now trivial.",
    aiSummary:
      "An elite CAT Time & Work session using the LCM shortcut to eliminate all fraction arithmetic. Covers combined work, pipes and cisterns, negative work, and alternate-day patterns — with every problem solved in under 60 seconds using ratio-based fast methods.",
    keyTakeaways: [
      "LCM method: assume total work = LCM of all given days — eliminates fractions entirely",
      "Combined work rate: if A does work in a days and B in b days, together they take ab/(a+b) days",
      "Pipe-and-cistern: filling pipes are positive, emptying pipes are negative — add rates algebraically",
      "Alternate-day work: find work done in 2-day cycle, then multiply to reach completion",
      "Efficiency ratio: if A is twice as efficient as B, A takes half the time — ratio of times is inverse of ratio of efficiencies",
      "Remaining work after partial completion: total work (LCM units) minus work already done",
      "CAT trap: 'A and B together finish in x days, B alone in y days — find A alone' — use subtraction of rates, not days",
    ],
    quiz: [
      {
        id: "twq1",
        question: "A can complete a work in 12 days, B in 18 days. Working together, how many days to finish?",
        options: ["7.2 days", "6 days", "8 days", "7 days"],
        correctIndex: 0,
        explanation: "LCM of 12 and 18 = 36 units. A does 3 units/day, B does 2 units/day. Together = 5 units/day. Time = 36/5 = 7.2 days. Formula: ab/(a+b) = 12×18/30 = 7.2 days.",
      },
      {
        id: "twq2",
        question: "A pipe fills a tank in 6 hours, another empties it in 10 hours. Both open together — tank fills in:",
        options: ["15 hours", "16 hours", "12 hours", "20 hours"],
        correctIndex: 0,
        explanation: "LCM = 30. Filling rate = 5 units/hr, emptying rate = 3 units/hr. Net = 5 − 3 = 2 units/hr. Time = 30/2 = 15 hours. Emptying pipes are negative — always subtract their rate.",
      },
      {
        id: "twq3",
        question: "A and B together finish work in 8 days. B alone takes 12 days. How long does A take alone?",
        options: ["24 days", "20 days", "18 days", "16 days"],
        correctIndex: 0,
        explanation: "LCM of 8 and 12 = 24 units. Together rate = 3/day, B rate = 2/day. A rate = 3 − 2 = 1 unit/day. A alone = 24 days. Never subtract days directly — always subtract rates.",
      },
    ],
  },
  {
    id: "cat-video-uryty7asb3c",
    youtubeId: "UrytY7asb3c",
    title: "CAT Advanced Strategy Session",
    instructor: "CATalyst AI",
    description:
      "An elite CAT VARC strategy session focused on high-accuracy comprehension, option elimination frameworks, and exam-day execution patterns used by top percentile scorers.",
    duration: "47:20",
    views: "28K",
    rating: 4.9,
    category: "VARC",
